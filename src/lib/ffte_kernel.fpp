...
!dir$ simd
   ...
   10 CONTINUE
      ...
      USE CONSTANTS_MOD
      IMPLICIT REAL(WP) (A-H,O-Z)
      complex(wp) A(L,*),B(3,*),W(2,*)
      complex(wp) C0,C1,C2,D0,D1,D2,W1,W2
...
!     DIMENSION A(2,L,*),B(2,5,*),W(2,4,*)
      complex(wp) a(L,*), B(5,*), W(4,*)
      complex(wp) C0,C1,C2,C3,C4,D0,D1,D2,D3,D4,D5,D6,D7,D8,D9,D10
      complex(wp) W1,W2,W3,W4
...
!dir$ simd
      DO 10 J=1,L
        ...
        D7=D6+D5
        D8=D6-D5
        D9=(0.0_wp,-1.0_wp)*(D2+C52*D3)
        D10=(0.0_wp,-1.0_wp)*(C52*D2-D3)
        B(1,J)=C0+D4
        B(2,J)=W1*(D7+D9)
        B(3,J)=W2*(D8+D10)
        B(4,J)=W3*(D8-D10)
...
!dir$ simd
   ...
   30 CONTINUE
      ...
      USE CONSTANTS_MOD
      IMPLICIT REAL(WP) (A-H,O-Z)
      complex(wp) A(L,*), B(8,*), W(7,*)
      complex(wp) C0,C1,C2,C3,C4,C5,C6,C7,D0,D1,D2,D3,D4,D5,D6,D7
      complex(wp) E0,E1,E2,E3,E4,E5,E6,E7,E8,E9,W1,W2,W3,W4,W5,W6,W7
...
!dir$ simd
      DO 10 J=1,L
        ...
        E1=D0-D2
        E2=D4+D6
        E3=(0.0_wp,-1.0_wp)*(D4-D6)
        E4=C81*(D5-D7)
        E5=(0.0_wp,-1.0_wp)*C81*(D5+D7)
        E6=D1+E4
        E7=D1-E4
        E8=D3+E5
        E9=D3-E5
