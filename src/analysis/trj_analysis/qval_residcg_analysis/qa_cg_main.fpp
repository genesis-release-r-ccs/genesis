...
program qa_cg_main
  ...
  call setup(ctrl_data, molecule, trj_list, trajectory, output, option, native_contact)
  ...
  call analyze(molecule, trj_list, output, option, native_contact, trajectory)
