...
program ca_main
  ...
  call setup(ctrl_data, molecule, trj_list, trajectory, fitting, output, option)
  ...
  call analyze(molecule, trj_list, output, fitting, option,  trajectory)
