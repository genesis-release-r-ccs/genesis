...
contains
  ...
  subroutine show_ctrl_option
    ...
    write(MsgOut,'(A)') 'num_pca        = 1               # # of principal components'
  ...
  subroutine read_ctrl_option(handle, opt_info)
    ...
    call read_ctrlfile_integer(handle, Section, 'num_pca', &
                               opt_info%num_pca)
  ...
  subroutine setup_option(opt_info, sel_info, molecule, option)
    ...
    option%num_pca    = opt_info%num_pca
