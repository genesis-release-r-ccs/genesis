...
module rdf_control_mod
  ...
  ! structures
  type, public :: s_rdf_ctrl_data

    ! data for section option
    type(s_rdf_opt_info)      :: rdf_opt_info

  end type s_rdf_ctrl_data
...
contains
  ...
  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    rdf_usage
  !> @brief        show rdf_usage of trj_analysis
  !! @authors      TM
  !! @param[in]    arg1 : arguments in execution
  !
  !======1=========2=========3=========4=========5=========6=========7=========8

  subroutine rdf_usage(arg1)
  ...
  end subroutine rdf_usage

  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    rdf_control
  ...
  subroutine rdf_control(filename, rdf_ctrl_data)

    ! formal arguments
    character(*),            intent(in)    :: filename
    type(s_rdf_ctrl_data),   intent(inout) :: rdf_ctrl_data
    ...
    ! read option section
    call read_ctrl_option(handle, rdf_ctrl_data%rdf_opt_info)
  ...
  end subroutine rdf_control

end module rdf_control_mod
