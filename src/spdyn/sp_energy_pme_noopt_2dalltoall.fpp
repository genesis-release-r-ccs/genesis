...
!   if (enefunc%vdw == VDWPME) then
!     deallocate(gx, gy, gz, vir_fact, vi, theta, theta_lj,         &
!                ftqdf_work2, ftldf_work2, qdf, qdf_real, qdf_work, &
!                ldf, ldf_real, ldf_work, ftqdf, ftqdf_work,        &
!                ftldf, ftldf_work, stat = dealloc_stat)
!   else
