!--------1---------2---------3---------4---------5---------6---------7---------8
!
!  Module   sp_energy_pme_opt_2dalltoall_mod
...
contains
  ...
  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    setup_pme_opt_2dalltoall
  ...
  subroutine setup_pme_opt_2dalltoall(domain, boundary, enefunc, calc)
  ...
  end subroutine setup_pme_opt_2dalltoall
  ...
  end subroutine dealloc_pme_opt_2dalltoall

  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    pme_pre_opt_2dalltoall
  ...
  subroutine pme_pre_opt_2dalltoall(domain, boundary)
  ...
  !======1=========2=========3=========4=========5=========6=========7=========8
  !
  !  Subroutine    pme_recip_opt_2dalltoall_4
...
!ocl nosimd
    ...
    do ix = id+1, nix, nthread
      do iy = 1, niy
        ...
        vzz = 0.0_wp
        do iz = 1, ngrid(3)
          tqq1 = real(ftqdf_work2(iz,iy,ix),wp)
          tqq2 = imag(ftqdf_work2(iz,iy,ix))
    ...
    if(my_x_rank == 0 .and. my_y_rank == 0) then
      ...
      do iy = id+1, niy, nthread
        ...
        vzz = 0.0_wp
        do iz = 1, ngrid(3)
          tqq1 = real(ftqdf_work2(iz,iy,1),wp)
          tqq2 = imag(ftqdf_work2(iz,iy,1))
          tqq  = tqq1*tqq1 + tqq2*tqq2
        ...
        do iz = 1, ngrid(3)
          tqq1 = real(ftqdf_work2(iz,iy,nix1),wp)
          tqq2 = imag(ftqdf_work2(iz,iy,nix1))
          tqq  = tqq1*tqq1 + tqq2*tqq2
...
!ocl nosimd
  ...
  subroutine pme_recip_opt_2dalltoall_6(domain, force, virial, eelec)
...
!ocl norecurrence(qdf)
  ...
  end subroutine pme_recip_opt_2dalltoall_6
...
!ocl nosimd
  ...
  subroutine pme_recip_opt_2dalltoall_8(domain, force, virial, eelec)
...
!ocl norecurrence(qdf)
  ...
  end subroutine pme_recip_opt_2dalltoall_8
