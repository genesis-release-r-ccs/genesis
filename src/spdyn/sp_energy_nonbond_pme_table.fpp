!--------1---------2---------3---------4---------5---------6---------7---------8
!
!  Module   sp_energy_nonbond_pme_table_mod
...
contains
  ...
  subroutine compute_energy_nonbond_table_linear( &
    ...
    case (NBK_Intel)
      call compute_energy_nonbond_tbl_lnr_intel( &
                              domain, enefunc, pairlist, atmcls_pbc, &
                              coord_pbc, force_pbc, virial,          &
                              eelec, evdw)
  ...
  subroutine compute_force_nonbond_table_linear( &
    ...
    case (NBK_Intel)
      call compute_force_nonbond_tbl_lnr_intel( &
                              domain, enefunc, pairlist, npt,        &
                              atmcls_pbc, coord_pbc, force_pbc, virial)
    ...
    case (NBK_GPU)
      call compute_force_nonbond_tbl_lnr_gpu( &
                              domain, enefunc, pairlist, npt,        &
                              cpu_calc, coord_pbc, force, force_pbc, &
                              virial, ene_virial)
  ...
  subroutine compute_energy_nonbond_table_linear_fep( &
    ...
    case (NBK_GPU)
      call compute_energy_nonbond_tbl_lnr_gpu_fep( &
                              domain, enefunc, pairlist, npt,        &
                              coord_pbc, force_pbc, virial,          &
                              eelec, evdw, ene_virial)
    ...
    if (domain%nonbond_kernel /= NBK_GPU) then
      call compute_energy_nonbond_tbl_lnr_generic_fep( &
        domain, enefunc, pairlist, virial_cell, eelec, evdw)
    end if
  ...
  subroutine compute_energy_nonbond_table_linear_check_fep( &
    ...
    call compute_energy_nonbond_tbl_lnr_chk_generic_fep( &
                              domain, enefunc, pairlist, &
                              virial_cell, eelec, evdw)
  ...
  subroutine compute_force_nonbond_table_linear_fep( &
    ...
    case (NBK_GPU)
      call compute_force_nonbond_tbl_lnr_gpu_fep( &
                              domain, enefunc, pairlist, npt,        &
                              cpu_calc, coord_pbc, force, force_pbc, &
                              virial, ene_virial)
    ...
    if (domain%nonbond_kernel /= NBK_GPU) then
      call compute_force_nonbond_tbl_lnr_generic_fep( &
        domain, enefunc, pairlist, virial_cell)
    end if
...
end module sp_energy_nonbond_pme_table_mod
